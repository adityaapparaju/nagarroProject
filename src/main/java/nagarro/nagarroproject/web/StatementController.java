...
public class StatementController {
    ...
    public String main(Model model, @ModelAttribute("statement") @Valid StatementDto statementDto) {
    	...
    	catch(ParseException e)
    	{
    		...
    		model.addAttribute(MESSAGE_ATTRIBUTE,"Invalid date format" );
    		return "main";
    	}
    	catch(Exception e)
    	{
    		log.error(String.format("invalid details %s", e));

    		model.addAttribute(MESSAGE_ATTRIBUTE,"invalid details" );
    		return "main";
    	}
